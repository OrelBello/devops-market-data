...
🪜 Help Desk / IT Support: 46 • SysAdmin / NOC: 14 • Trainee / Bootcamp Grad: 8

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Cloud (any) • Bash/Shell • Python

🏢 Companies hiring junior pipeline:
abra, Elbit Systems Israel, Extreme, Unity3D
