...
_Generated September 21, 2026 • Maintained by [Orel Bello](https://www.linkedin.com/in/orel-bello/) (FlipTheScript • AWS Community Builder)_


## Executive Summary

We tracked **101 open DevOps / SRE / Platform / Cloud roles** in Israel this week
...
**New companies in top 15:** Jobgether, Jeen.ai

## Top 10 In-Demand Skills

1. **Security** — 22 mentions
2. **Kubernetes** — 21 mentions
3. **AWS** — 19 mentions
4. **CI/CD** — 18 mentions
5. **Docker** — 14 mentions
6. **GCP** — 14 mentions
7. **Azure** — 13 mentions
8. **Linux** — 13 mentions
...
7. **Elbit Systems Israel** — 3 open roles
8. **NVIDIA** — 3 open roles
9. **Jobgether** — 3 open roles
