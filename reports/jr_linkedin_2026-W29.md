...
🔢 56 junior-pipeline roles this week
🪜 Help Desk / IT Support: 37 • SysAdmin / NOC: 12 • Trainee / Bootcamp Grad: 4

🛠️ The stack these roles want you to know:
Networking • Troubleshooting • Cloud (any) • Automation • Bash/Shell

🏢 Companies hiring junior pipeline:
LiveU, abra, מרטנס | Mertens – מקבוצת מלם תים, Anecdotes
