🪜 Israeli DevOps — Junior Pipeline — Week 28, 2026
...
🔢 59 junior-pipeline roles this week
🪜 SysAdmin / NOC: 25 • Help Desk / IT Support: 25 • Trainee / Bootcamp Grad: 6

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Cloud (any) • Linux • Bash/Shell

🏢 Companies hiring junior pipeline:
Elbit Systems Israel, abra, מרטנס | Mertens – מקבוצת מלם תים, Confidential Careers
...
100% free, real data, weekly updates. Built on OpenClaw / Accomplish.
