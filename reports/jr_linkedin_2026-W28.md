...
🔢 65 junior-pipeline roles this week
🪜 Help Desk / IT Support: 38 • SysAdmin / NOC: 19 • Trainee / Bootcamp Grad: 4

🛠️ The stack these roles want you to know:
Networking • Troubleshooting • Active Directory • Cloud (any) • Bash/Shell

🏢 Companies hiring junior pipeline:
מרטנס | Mertens – מקבוצת מלם תים, abra, NVIDIA, Elbit Systems Israel
