# Israeli DevOps Job Market Report — 2026-W36

_Generated August 31, 2026 • Maintained by [Orel Bello](https://www.linkedin.com/in/orel-bello/) (FlipTheScript • AWS Community Builder)_
...
**New companies in top 15:** Sela, Dialog

## Top 10 In-Demand Skills

1. **AWS** — 21 mentions
2. **CI/CD** — 21 mentions
3. **Kubernetes** — 19 mentions
4. **Security** — 18 mentions
5. **Azure** — 13 mentions
6. **Python** — 13 mentions
7. **GCP** — 12 mentions
8. **Terraform** — 12 mentions
9. **Docker** — 12 mentions
10. **Linux** — 11 mentions

## Top 10 Hiring Companies

1. **Gongio** — 6 open roles
2. **NVIDIA** — 4 open roles
3. **Via** — 3 open roles
4. **Taboola** — 3 open roles
5. **Nice** — 2 open roles
6. **Payoneer** — 2 open roles
7. **Jfrog** — 2 open roles
