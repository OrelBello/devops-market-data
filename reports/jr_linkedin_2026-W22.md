...
🪜 Help Desk / IT Support: 48 • SysAdmin / NOC: 20 • Trainee / Bootcamp Grad: 8

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Linux • Automation • Cloud (any)

🏢 Companies hiring junior pipeline:
abra, מרטנס | Mertens – מקבוצת מלם תים, Optimove, Radware
