...
🪜 Help Desk / IT Support: 45 • SysAdmin / NOC: 20 • Trainee / Bootcamp Grad: 9

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Automation • Linux • Python

🏢 Companies hiring junior pipeline:
abra, Elbit Systems Israel, מרטנס | Mertens – מקבוצת מלם תים, Optimove
