...
_Generated June 01, 2026 • Maintained by [Orel Bello](https://www.linkedin.com/in/orel-bello/) (FlipTheScript • AWS Community Builder)_
...
We tracked **75 junior-pipeline roles** in Israel that mention real DevOps stack:
...
1. **Troubleshooting** — required in 52 roles
2. **Networking** — required in 34 roles
3. **Python** — required in 22 roles
4. **Linux** — required in 21 roles
5. **Bash/Shell** — required in 21 roles
6. **Cloud (any)** — required in 21 roles
7. **Automation** — required in 20 roles
8. **Active Directory** — required in 17 roles
9. **Monitoring** — required in 13 roles
10. **Azure** — required in 11 roles
...
### IT Support Specialist — Cato Networks
📍 Tel Aviv District, Israel • 🎯 Learning Score: 54/100 • 🪜 Help Desk / IT Support

**Stack you'll work with:** Python, Bash/Shell, AWS, Azure, Cloud (any), Networking

🔗 [View role](https://il.linkedin.com/jobs/view/it-support-specialist-at-cato-networks-4398801612)
