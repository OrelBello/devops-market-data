...
🪜 Help Desk / IT Support: 47 • SysAdmin / NOC: 16 • Trainee / Bootcamp Grad: 11

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Cloud (any) • Python • Linux

🏢 Companies hiring junior pipeline:
Elbit Systems Israel, מרטנס | Mertens – מקבוצת מלם תים, Nice, abra
