...
🪜 Help Desk / IT Support: 48 • SysAdmin / NOC: 15 • Trainee / Bootcamp Grad: 10

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Cloud (any) • Linux • Python

🏢 Companies hiring junior pipeline:
Elbit Systems Israel, abra, Nice, מרטנס | Mertens – מקבוצת מלם תים
