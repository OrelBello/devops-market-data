...
🪜 Help Desk / IT Support: 35 • SysAdmin / NOC: 15 • Trainee / Bootcamp Grad: 6

🛠️ The stack these roles want you to know:
Networking • Troubleshooting • Cloud (any) • Active Directory • Automation

🏢 Companies hiring junior pipeline:
abra, מרטנס | Mertens – מקבוצת מלם תים, Unity3D, SQLink Group
