# Israeli DevOps Job Market Report — 2026-W24

_Generated June 14, 2026 • Maintained by [Orel Bello](https://www.linkedin.com/in/orel-bello/) (FlipTheScript • AWS Community Builder)_
...
📈 **Total jobs**: +0 (+0.0%) vs 2026-W23
📊 **Junior % change**: +0.0 pp

**Rising skills:**
- AI/MLOps: 0 → 7 (+7)
- Bash/Shell: 0 → 7 (+7)
- Observability: 15 → 19 (+4)
- Terraform: 13 → 17 (+4)
- Kubernetes: 20 → 23 (+3)
...
**New companies in top 15:** Elbit Systems Israel, Riskified, Applied Materials - Israel, abra, Lendbuzz

## Top 10 In-Demand Skills

1. **Security** — 29 mentions
2. **AWS** — 27 mentions
3. **CI/CD** — 26 mentions
4. **Kubernetes** — 23 mentions
5. **GCP** — 20 mentions
6. **Observability** — 19 mentions
7. **Azure** — 19 mentions
8. **Terraform** — 17 mentions
9. **Python** — 17 mentions
10. **Docker** — 16 mentions

## Top 10 Hiring Companies

1. **Nice** — 6 open roles
2. **Torq** — 6 open roles
3. **Jfrog** — 5 open roles
4. **Gongio** — 5 open roles
5. **Elbit Systems Israel** — 5 open roles
6. **NVIDIA** — 5 open roles
7. **Via** — 3 open roles
8. **Transmitsecurity** — 3 open roles
9. **Unity3D** — 2 open roles
10. **Similarweb** — 2 open roles
...
- **Junior**: _insufficient data_ (n=0)
- **Mid**: _insufficient data_ (n=0)
- **Senior**: _insufficient data_ (n=0)
