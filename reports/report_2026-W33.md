...
**New companies in top 15:** Appsflyer, NVIDIA AI, Jfrog, Torq, Riskified

## Top 10 In-Demand Skills

1. **CI/CD** — 16 mentions
2. **Kubernetes** — 15 mentions
3. **AWS** — 15 mentions
4. **Security** — 15 mentions
5. **Docker** — 11 mentions
6. **Python** — 11 mentions
7. **Terraform** — 10 mentions
8. **Linux** — 10 mentions
9. **GCP** — 9 mentions
10. **Azure** — 7 mentions
