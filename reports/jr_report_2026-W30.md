...
- **Help Desk / IT Support** — 39
- **SysAdmin / NOC** — 17
- **Trainee / Bootcamp Grad** — 4
...
1. **Networking** — required in 37 roles
2. **Troubleshooting** — required in 35 roles
3. **Bash/Shell** — required in 21 roles
4. **Cloud (any)** — required in 20 roles
5. **Active Directory** — required in 20 roles
6. **Linux** — required in 20 roles
7. **Monitoring** — required in 19 roles
8. **Automation** — required in 19 roles
9. **Python** — required in 18 roles
...
1. **abra** — 4 role(s)
2. **Nice** — 2 role(s)
3. **IAI - Israel Aerospace Industries** — 2 role(s)
4. **Anecdotes** — 2 role(s)
5. **Payoneer** — 1 role(s)
6. **Taboola** — 1 role(s)
...
### System Administrator — MER Group
📍 Or Yehuda, Tel Aviv District, Israel • 🎯 Learning Score: 76/100 • 🪜 SysAdmin / NOC

**Stack you'll work with:** Linux, Bash/Shell, AWS, Azure, Cloud (any), Networking

🔗 [View role](https://il.linkedin.com/jobs/view/system-administrator-at-mer-group-4436525380)
...
**Stack you'll work with:** Python, Bash/Shell, AWS, Azure, Cloud (any), Monitoring
