...
🪜 Help Desk / IT Support: 28 • SysAdmin / NOC: 19 • Trainee / Bootcamp Grad: 7

🛠️ The stack these roles want you to know:
Troubleshooting • Networking • Active Directory • Cloud (any) • Python

🏢 Companies hiring junior pipeline:
Elbit Systems Israel, abra, Unity3D, SQLink Group
