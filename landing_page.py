...
<header>
  ...
  <div style="margin-top:1.5rem; display:flex; gap:0.75rem; flex-wrap:wrap; justify-content:center">
    <a class="cta" href="{main_sheet_url}" target="_blank">Open the live dashboard →</a>
    <a class="cta cta-secondary" href="./devops-jobs-israel-latest.xlsx" download>📥 Download Excel (.xlsx)</a>
    <a class="cta cta-tertiary" href="./latest.json">📄 Get raw JSON</a>
  </div>
</header>
